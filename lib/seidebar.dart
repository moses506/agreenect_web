...
//                   children: [
//                     _buildSidebarItem('Home', Icons.home, () => _scrollToSection('Home')),
//                     _buildSidebarItem('About Us', Icons.info_outline, () => _scrollToSection('About Us')),
//                     _buildSidebarItem('Impact', Icons.trending_up, () => _scrollToSection('Impact')),
//                     _buildSidebarItem('Achievements', Icons.star_outline, () => _scrollToSection('Achievements')),
//                     _buildSidebarItem('Team', Icons.people_outline, () => _scrollToSection('Team')),
//                     _buildSidebarItem('Contact', Icons.contact_mail, () => _scrollToSection('Contact')),
//                   ],
//                 ),
//               ),
//               Container(
...
//                   errorBuilder: (context, error, stackTrace) => 
//                     Icon(Icons.eco, color: Colors.green[700], size: isMobile ? 22 : 28),
//                 ),
//               ),
//               const SizedBox(width: 12),
//               Text(
...
//                 _navButton('Achievements', () => _scrollToSection('Achievements')),
...
//                   errorBuilder: (context, error, stackTrace) => 
//                     Icon(Icons.agriculture, size: isMobile ? 80 : 120, color: Colors.green[600]),
//                 ),
...
//                 return Column(
//                   children: [
//                     _buildFeatureCard(Icons.phone_android, 'Mobile Platform',
//                         'Access farming knowledge, weather updates, and market prices on your smartphone', Colors.blue),
//                     const SizedBox(height: 30),
//                     _buildFeatureCard(Icons.cloud, 'Weather Intelligence',
//                         'Real-time weather data and climate-smart farming recommendations', Colors.orange),
//                     const SizedBox(height: 30),
//                     _buildFeatureCard(Icons.trending_up, 'Market Access',
//                         'Connect directly with buyers and access fair market prices', Colors.green),
//                     const SizedBox(height: 30),
//                     _buildFeatureCard(Icons.school, 'Digital Learning',
//                         'Interactive training modules on sustainable farming practices', Colors.purple),
//                   ],
//                 );
//               } else {
//                 return Wrap(
...
//             ? Column(
//                 children: [
//                   _buildStatCard('500+', 'Farmers Reached'),
//                   const SizedBox(height: 20),
...
//               ? Column(
//                   children: [
//                     _buildMVVCard(Icons.rocket_launch, 'Mission',
//                         'Empower smallholder farmers with digital tools, knowledge, and support to enhance productivity and resilience.', Colors.blue),
//                     const SizedBox(height: 30),
//                     _buildMVVCard(Icons.visibility, 'Vision',
//                         'A digitally-enabled, resilient agricultural sector driven by youth-led innovation and environmental stewardship.', Colors.green),
//                     const SizedBox(height: 30),
//                     _buildMVVCard(Icons.favorite, 'Values',
//                         'Innovation • Sustainability • Empowerment • Integrity • Collaboration', Colors.orange),
//                   ],
//                 )
//               : Row(
...
//   Widget _buildMVVCard(IconData icon, String title, String content, Color color) {
//     final isMobile = _isMobile(context);
...
//                     Row(
//                       children: [
//                         Expanded(child: _buildImpactCard(Icons.eco, 'Climate-Smart\nPractices', Colors.green)),
//                         const SizedBox(width: 20),
//                         Expanded(child: _buildImpactCard(Icons.landscape, 'Land\nRestoration', Colors.brown)),
//                       ],
//                     ),
//                     const SizedBox(height: 20),
//                     Row(
//                       children: [
//                         Expanded(child: _buildImpactCard(Icons.device_thermostat, 'Climate\nResilience', Colors.orange)),
//                         const SizedBox(width: 20),
//                         Expanded(child: _buildImpactCard(Icons.trending_up, 'Market\nAccess', Colors.blue)),
//                       ],
//                     ),
//                   ],
//                 )
...
//                   alignment: WrapAlignment.center,
//                   children: [
//                     _buildImpactCard(Icons.eco, 'Climate-Smart\nPractices', Colors.green),
//                     _buildImpactCard(Icons.landscape, 'Land\nRestoration', Colors.brown),
//                     _buildImpactCard(Icons.device_thermostat, 'Climate\nResilience', Colors.orange),
//                     _buildImpactCard(Icons.trending_up, 'Market\nAccess', Colors.blue),
//                   ],
//                 ),
//         ],
//       ),
...
//                 Row(
//                   children: [
//                     Expanded(child: _buildStatsCard('300+', 'Farmers Trained', Icons.people)),
//                     const SizedBox(width: 20),
//                     Expanded(child: _buildStatsCard('15+', 'Communities', Icons.location_city)),
//                   ],
//                 ),
//                 const SizedBox(height: 30),
//                 Row(
//                   children: [
//                     Expanded(child: _buildStatsCard('95%', 'Satisfaction Rate', Icons.thumb_up)),
//                     const SizedBox(width: 20),
//                     Expanded(child: _buildStatsCard('3+', 'Years Experience', Icons.timeline)),
//                   ],
//                 ),
//               ],
//             )
...
//     return Column(
//       children: [
//         Icon(icon, size: isMobile ? 30 : 40, color: Colors.white.withValues(alpha: 0.8)),
//         const SizedBox(height: 15),
//         Text(
//           number,
//           style: TextStyle(
...
//   Widget _buildAchievementCard(String image, String title, String description, Color color) {
//     final isMobile = _isMobile(context);
...
//                     Row(
//                       children: [
//                         Expanded(child: _buildTeamCard('CEO & Founder', 'David Chapoloko')),
//                         const SizedBox(width: 15),
//                         Expanded(child: _buildTeamCard('Financial & Admin Lead', 'Contance Mubanga')),
//                       ],
//                     ),
//                     const SizedBox(height: 20),
//                     Row(
//                       children: [
//                         Expanded(child: _buildTeamCard('Partnership & Outreach', 'Sera Banda')),
//                         const SizedBox(width: 15),
//                         Expanded(child: _buildTeamCard('Technical/ Developer', 'Moses Mpande')),
//                       ],
//                     ),
//                     const SizedBox(height: 20),
//                     Row(
//                       children: [
//                         Expanded(child: _buildTeamCard('Field Coordinator', 'Stanely Sampa Chemebe')),
//                         const SizedBox(width: 15),
//                         Expanded(child: _buildTeamCard('Field Coordinator', 'Yonah Simwawa')),
//                       ],
//                     ),
//                   ],
//                 );
...
//                   alignment: WrapAlignment.center,
//                   children: [
//                     _buildTeamCard('CEO & Founder', 'David Chapoloko'),
//                     _buildTeamCard('Financial & Admin Lead', 'Contance Mubanga'),
//                     _buildTeamCard('Partnership & Outreach', 'Sera Banda'),
//                     _buildTeamCard('Technical/ Developer', 'Moses Mpande'),
//                     _buildTeamCard('Field Coordinator', 'Stanely Sampa Chemebe'),
//                     _buildTeamCard('Field Coordinator', 'Yonah Simwawa'),
//                   ],
//                 );
//               }
//             },
...
//   Widget _buildTeamCard(String role, String name) {
//     final isMobile = _isMobile(context);
...
//             name,
//             textAlign: TextAlign.center,
//             style: TextStyle(fontSize: isMobile ? 10 : 14, color: Colors.grey[600]),
//           ),
//         ],
//       ),
//     );
...
//           const SizedBox(height: 50),
//           Center(
//             child: _buildPartnerCard('Agri Train Initiative\nZambia', Icons.agriculture),
//           ),
//         ],
//       ),
//     );
...
//   Widget _buildPartnerCard(String name, IconData icon) {
//     final isMobile = _isMobile(context);
...
//               ? Column(
//                   children: [
//                     _buildContactCard(Icons.email, 'Email', 'chapolokodavifpfg@gmail.com'),
//                     const SizedBox(height: 20),
//                     _buildContactCard(Icons.phone, 'Phone', '+260 768233023'),
//                     const SizedBox(height: 20),
//                     _buildContactCard(Icons.location_on, 'Address', 'Lusaka, Zambia'),
//                   ],
//                 )
//               : Wrap(
//                   spacing: 40,
